...
public enum CommandType {
    WARPTO_DIRECT(0x02), WARPTO_MAP(0x04), LOAD_MAP(0x0C), CALL(0x0D), LOAD(0x2D), KAOMADO(0x2E), 
    ...
    MOVE_CAMERA_TO_WAYPOINT(0x86), FACE_DIR(0x8B), ROTATE(0x91),
    LOAD_EVENT_FLAG(0xC0), LOAD_EVENT_FLAG_CALC(0xC1), LOAD_TWO_EVENT_FLAGS_CALC(0xC2), CHOOSE_RANDOM_VALUE(0xC3),
    LOAD_FIRST_EVENT_FLAG_BYTE(0xC4), LOAD_SECOND_EVENT_FLAG_BYTE(0xC5),
    TEST_EQUALS(0xCC), TEST_CONDITION(0xCD), TEST_CONDITION_CUSTOM(0xCE), VARY_MSG(0xCF),
    CASE(0xD0), DEFAULT(0xD1), QUESTION(0xD5), VARY_QUESTION(0xD8), OPTION(0xD9),
    SLEEP(0xDB), WAIT_SEND(0xE2), WAIT_FLAG(0xE3), SET_FLAG(0xE4), GOTO_LABEL(0xE7), EXECUTE(0xE8),
    MSG_END(0xE9), RETURN(0xEE), END(0xEF), CLOSE(0xF0), REMOVE(0xF1), LABEL(0xF4), START_THREAD(0xF6);
